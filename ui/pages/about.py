...
def about_page():
    ...
    st.write(
        "1. **Equipment Design:** Develop a device capable of reproducing the specified curve."
    )
    st.write(
    ...
    st.header("Note ℹ️")
    st.write(
        "This project is part of the 'PIE - Projet d'Ingénieur en Équipe' course at ENSTA Paris."
    )
